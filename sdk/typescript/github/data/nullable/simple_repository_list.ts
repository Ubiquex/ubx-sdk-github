// Code generated by `ubx sdk gen` from github_nullable_simple_repository_list. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface SimpleRepositoryList_AccessibleRepositories_Owner {
...
export interface SimpleRepositoryList_AccessibleRepositories {
  ...
  owner?: SimpleRepositoryList_AccessibleRepositories_Owner | Computed<SimpleRepositoryList_AccessibleRepositories_Owner>;
...
export interface SimpleRepositoryListConfig {
  enterprise: string | Computed<string>;
  page?: number | Computed<number>;
  perPage?: number | Computed<number>;
}

export interface SimpleRepositoryListAttrs {
  accessibleRepositories: SimpleRepositoryList_AccessibleRepositories[];
...
export const SimpleRepositoryList: DataSourceBinding<SimpleRepositoryListConfig, SimpleRepositoryListAttrs> = {
  wireType: "github_nullable_simple_repository_list",
  fields: {
