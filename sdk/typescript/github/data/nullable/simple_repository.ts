...
export interface SimpleRepository_AccessibleRepositories_Owner {
...
export interface SimpleRepository_AccessibleRepositories {
  ...
  owner?: SimpleRepository_AccessibleRepositories_Owner | Computed<SimpleRepository_AccessibleRepositories_Owner>;
...
export interface SimpleRepositoryConfig {
  enterprise: string | Computed<string>;
  page?: number | Computed<number>;
  perPage?: number | Computed<number>;
}

export interface SimpleRepositoryAttrs {
  accessibleRepositories: SimpleRepository_AccessibleRepositories[];
...
export const SimpleRepository: DataSourceBinding<SimpleRepositoryConfig, SimpleRepositoryAttrs> = {
