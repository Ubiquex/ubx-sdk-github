// Code generated by `ubx sdk gen` from github_minimal_repository_list. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface RepositoryList_Repositories_CodeOfConduct {
...
export interface RepositoryList_Repositories_License {
  key?: string | Computed<string>;
  name?: string | Computed<string>;
...
export interface RepositoryList_Repositories_Owner {
...
export interface RepositoryList_Repositories_Permissions {
...
export interface RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity {
  status?: string | Computed<string>;
}

export interface RepositoryList_Repositories_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions_Reviewers {
  mode?: string | Computed<string>;
  reviewerId?: number | Computed<number>;
  reviewerType?: string | Computed<string>;
}

export interface RepositoryList_Repositories_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions {
  reviewers?: RepositoryList_Repositories_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions_Reviewers[] | Computed<RepositoryList_Repositories_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions_Reviewers[]>;
}

export interface RepositoryList_Repositories_SecurityAndAnalysis {
  advancedSecurity?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
  codeSecurity?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
  dependabotSecurityUpdates?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
  secretScanning?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
  secretScanningAiDetection?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
  secretScanningDelegatedAlertDismissal?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
  secretScanningDelegatedBypass?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
  secretScanningDelegatedBypassOptions?: RepositoryList_Repositories_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions | Computed<RepositoryList_Repositories_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions>;
  secretScanningNonProviderPatterns?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
  secretScanningPushProtection?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
  secretScanningValidityChecks?: RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity | Computed<RepositoryList_Repositories_SecurityAndAnalysis_AdvancedSecurity>;
}

export interface RepositoryList_Repositories {
  ...
  codeOfConduct?: RepositoryList_Repositories_CodeOfConduct | Computed<RepositoryList_Repositories_CodeOfConduct>;
  ...
  license?: RepositoryList_Repositories_License | Computed<RepositoryList_Repositories_License>;
  ...
  owner?: RepositoryList_Repositories_Owner | Computed<RepositoryList_Repositories_Owner>;
  permissions?: RepositoryList_Repositories_Permissions | Computed<RepositoryList_Repositories_Permissions>;
  ...
  securityAndAnalysis?: RepositoryList_Repositories_SecurityAndAnalysis | Computed<RepositoryList_Repositories_SecurityAndAnalysis>;
...
export interface RepositoryListConfig {
...
export interface RepositoryListAttrs {
  org: string;
  page: number;
  perPage: number;
...
export const RepositoryList: DataSourceBinding<RepositoryListConfig, RepositoryListAttrs> = {
  wireType: "github_minimal_repository_list",
  fields: {
    org: "org",
    page: "page",
    perPage: "per_page",
