// Code generated by `ubx sdk gen` from github_repo_search_result_item. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface SearchResultItem_Items_License {
...
export interface SearchResultItem_Items_Owner {
...
export interface SearchResultItem_Items_Permissions {
...
export interface SearchResultItem_Items {
  ...
  license?: SearchResultItem_Items_License | Computed<SearchResultItem_Items_License>;
  ...
  owner?: SearchResultItem_Items_Owner | Computed<SearchResultItem_Items_Owner>;
  permissions?: SearchResultItem_Items_Permissions | Computed<SearchResultItem_Items_Permissions>;
...
export const SearchResultItem: DataSourceBinding<SearchResultItemConfig, SearchResultItemAttrs> = {
  wireType: "github_repo_search_result_item",
  fields: {
    order: "order",
    page: "page",
    perPage: "per_page",
