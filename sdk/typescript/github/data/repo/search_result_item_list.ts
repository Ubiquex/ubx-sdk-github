// Code generated by `ubx sdk gen` from github_repo_search_result_item_list. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface SearchResultItemList_Items_License {
...
export interface SearchResultItemList_Items_Owner {
...
export interface SearchResultItemList_Items_Permissions {
...
export interface SearchResultItemList_Items {
  ...
  license?: SearchResultItemList_Items_License | Computed<SearchResultItemList_Items_License>;
  ...
  owner?: SearchResultItemList_Items_Owner | Computed<SearchResultItemList_Items_Owner>;
  permissions?: SearchResultItemList_Items_Permissions | Computed<SearchResultItemList_Items_Permissions>;
...
export const SearchResultItemList: DataSourceBinding<SearchResultItemListConfig, SearchResultItemListAttrs> = {
  wireType: "github_repo_search_result_item_list",
  fields: {
    order: "order",
    page: "page",
    perPage: "per_page",
