...
export interface Billing_Seats_Assignee {
...
export interface Billing_Seats_AssigningTeam_Parent {
...
export interface Billing_Seats_AssigningTeam_Permissions {
...
export interface Billing_Seats_AssigningTeam {
  ...
  parent?: Billing_Seats_AssigningTeam_Parent | Computed<Billing_Seats_AssigningTeam_Parent>;
  permission?: string | Computed<string>;
  permissions?: Billing_Seats_AssigningTeam_Permissions | Computed<Billing_Seats_AssigningTeam_Permissions>;
  privacy?: string | Computed<string>;
  repositoriesUrl?: string | Computed<string>;
  slug?: string | Computed<string>;
...
export interface Billing_Seats_Organization {
  avatarUrl?: string | Computed<string>;
  description?: string | Computed<string>;
  eventsUrl?: string | Computed<string>;
...
export interface Billing_Seats {
  assignee?: Billing_Seats_Assignee | Computed<Billing_Seats_Assignee>;
  assigningTeam?: Billing_Seats_AssigningTeam | Computed<Billing_Seats_AssigningTeam>;
  createdAt?: string | Computed<string>;
  lastActivityAt?: string | Computed<string>;
  lastActivityEditor?: string | Computed<string>;
  lastAuthenticatedAt?: string | Computed<string>;
  organization?: Billing_Seats_Organization | Computed<Billing_Seats_Organization>;
...
export const Billing: DataSourceBinding<BillingConfig, BillingAttrs> = {
