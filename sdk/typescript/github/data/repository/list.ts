...
export interface List_Repositories_CodeSearchIndexStatus {
  lexicalCommitSha?: string | Computed<string>;
  lexicalSearchOk?: boolean | Computed<boolean>;
}

export interface List_Repositories_License {
...
export interface List_Repositories_Owner {
...
export interface List_Repositories_Permissions {
...
export interface List_Repositories {
  ...
  codeSearchIndexStatus?: List_Repositories_CodeSearchIndexStatus | Computed<List_Repositories_CodeSearchIndexStatus>;
  ...
  license?: List_Repositories_License | Computed<List_Repositories_License>;
  ...
  owner?: List_Repositories_Owner | Computed<List_Repositories_Owner>;
  permissions?: List_Repositories_Permissions | Computed<List_Repositories_Permissions>;
