// Code generated by `ubx sdk gen` from github_public_ip_list. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface IpList_ImageDetails {
...
export interface IpList_MachineSizeDetails {
  /** The number of cores. */
...
export interface IpList_PublicIps {
...
export interface IpListAttrs {
  ...
  machineSizeDetails: IpList_MachineSizeDetails;
...
export const IpList: DataSourceBinding<IpListConfig, IpListAttrs> = {
