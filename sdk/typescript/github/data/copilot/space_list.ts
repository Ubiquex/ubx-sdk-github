...
export interface SpaceList_Spaces_Creator {
...
export interface SpaceList_Spaces_Owner {
  avatarUrl?: string | Computed<string>;
...
export interface SpaceList_Spaces_ResourcesAttributes_Metadata {
...
export interface SpaceList_Spaces_ResourcesAttributes {
  copilotChatAttachmentId?: number | Computed<number>;
  createdAt?: string | Computed<string>;
  id?: number | Computed<number>;
  metadata?: SpaceList_Spaces_ResourcesAttributes_Metadata | Computed<SpaceList_Spaces_ResourcesAttributes_Metadata>;
  resourceType?: string | Computed<string>;
  updatedAt?: string | Computed<string>;
}

export interface SpaceList_Spaces {
  apiUrl?: string | Computed<string>;
  baseRole?: string | Computed<string>;
  createdAt?: string | Computed<string>;
  creator?: SpaceList_Spaces_Creator | Computed<SpaceList_Spaces_Creator>;
  description?: string | Computed<string>;
  ...
  name?: string | Computed<string>;
  number?: number | Computed<number>;
  owner?: SpaceList_Spaces_Owner | Computed<SpaceList_Spaces_Owner>;
  resourcesAttributes?: SpaceList_Spaces_ResourcesAttributes[] | Computed<SpaceList_Spaces_ResourcesAttributes[]>;
  updatedAt?: string | Computed<string>;
}
...
export interface SpaceListAttrs {
  after: string;
  before: string;
  org: string;
  perPage: number;
  /** The list of Copilot Spaces on this page of results. */
  spaces: SpaceList_Spaces[];
}

export const SpaceList: DataSourceBinding<SpaceListConfig, SpaceListAttrs> = {
