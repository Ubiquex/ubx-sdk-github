// Code generated by `ubx sdk gen` from github_copilot_seat_details_list. DO NOT EDIT.
import type { Computed, FieldMap, DataSourceBinding } from "@ubx/sdk";

export interface SeatDetailsList_Seats_Assignee {
...
export interface SeatDetailsList_Seats_AssigningTeam_Parent {
...
export interface SeatDetailsList_Seats_AssigningTeam_Permissions {
...
export interface SeatDetailsList_Seats_AssigningTeam {
  ...
  parent?: SeatDetailsList_Seats_AssigningTeam_Parent | Computed<SeatDetailsList_Seats_AssigningTeam_Parent>;
  permission?: string | Computed<string>;
  permissions?: SeatDetailsList_Seats_AssigningTeam_Permissions | Computed<SeatDetailsList_Seats_AssigningTeam_Permissions>;
  privacy?: string | Computed<string>;
  repositoriesUrl?: string | Computed<string>;
  slug?: string | Computed<string>;
...
export interface SeatDetailsList_Seats_Organization {
  avatarUrl?: string | Computed<string>;
  description?: string | Computed<string>;
  eventsUrl?: string | Computed<string>;
...
export interface SeatDetailsList_Seats {
  assignee?: SeatDetailsList_Seats_Assignee | Computed<SeatDetailsList_Seats_Assignee>;
  assigningTeam?: SeatDetailsList_Seats_AssigningTeam | Computed<SeatDetailsList_Seats_AssigningTeam>;
  createdAt?: string | Computed<string>;
  lastActivityAt?: string | Computed<string>;
  lastActivityEditor?: string | Computed<string>;
  lastAuthenticatedAt?: string | Computed<string>;
  organization?: SeatDetailsList_Seats_Organization | Computed<SeatDetailsList_Seats_Organization>;
  pendingCancellationDate?: string | Computed<string>;
  planType?: string | Computed<string>;
  updatedAt?: string | Computed<string>;
}

export interface SeatDetailsListConfig {
  enterprise: string | Computed<string>;
  page?: number | Computed<number>;
  perPage?: number | Computed<number>;
}

export interface SeatDetailsListAttrs {
  enterprise: string;
  page: number;
  perPage: number;
  seats: SeatDetailsList_Seats[];
...
export const SeatDetailsList: DataSourceBinding<SeatDetailsListConfig, SeatDetailsListAttrs> = {
