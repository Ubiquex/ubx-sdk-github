...
type SearchResultItemList_Items_Repository_Owner struct {
	AvatarUrl         any
	Email             any
	EventsUrl         any
	FollowersUrl      any
...
type SearchResultItemList_Items_Repository_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions struct {
	Reviewers any
}
