...
type SearchResultItemList_Items_Assignee struct {
	AvatarUrl any
	Email any
	EventsUrl any
	FollowersUrl any
...
type SearchResultItemList_Items_IssueDependenciesSummary struct {
	BlockedBy any
	Blocking any
	TotalBlockedBy any
	TotalBlocking any
...
type SearchResultItemList_Items_IssueFieldValues_MultiSelectOptions struct {
	Color any
	Id any
	Name any
}

type SearchResultItemList_Items_IssueFieldValues struct {
	DataType any
	IssueFieldId any
	IssueFieldName any
...
type SearchResultItemList_Items_Labels struct {
	Color any
	Default any
	Description any
	Id any
...
type SearchResultItemList_Items_Milestone struct {
	ClosedAt any
	ClosedIssues any
	CreatedAt any
	Creator any
...
type SearchResultItemList_Items_PerformedViaGithubApp_Owner struct {
	AvatarUrl any
	CreatedAt any
	Description any
	Email any
...
type SearchResultItemList_Items_PerformedViaGithubApp_Permissions struct {
	Checks any
	Contents any
	Deployments any
	Issues any
...
type SearchResultItemList_Items_PerformedViaGithubApp struct {
	ClientId any
	CreatedAt any
	Description any
	Events any
...
type SearchResultItemList_Items_PinnedComment_Minimized struct {
	Reason any
}

type SearchResultItemList_Items_PinnedComment_Pin struct {
	PinnedAt any
	PinnedBy any
}

type SearchResultItemList_Items_PinnedComment_Reactions struct {
	Confused any
	Eyes any
	Heart any
	Hooray any
...
type SearchResultItemList_Items_PinnedComment struct {
...
type SearchResultItemList_Items_PullRequest struct {
	DiffUrl any
	HtmlUrl any
	MergedAt any
	PatchUrl any
...
type SearchResultItemList_Items_Repository_CodeSearchIndexStatus struct {
...
type SearchResultItemList_Items_SubIssuesSummary struct {
	Completed any
...
type SearchResultItemList_Items_Type struct {
	Color any
	CreatedAt any
	Description any
	Id any
