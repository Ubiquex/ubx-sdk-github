...
type UserList_Dependency struct {
...
type UserList_DismissalRequest_Requester struct {
...
type UserList_DismissalRequest struct {
...
type UserList_SecurityAdvisory_Cvss struct {
...
type UserList_SecurityAdvisory_CvssSeverities struct {
	CvssV3 any
	CvssV4 any
}
...
type UserList_SecurityAdvisory_References struct {
	Url any
}

type UserList_SecurityAdvisory_Vulnerabilities_FirstPatchedVersion struct {
	Identifier any
}
...
type UserList_SecurityAdvisory struct {
