...
type User_Dependency_Package struct {
...
type User_DismissalRequest_Requester struct {
...
type User_DismissalRequest struct {
...
type User_SecurityAdvisory_Cvss struct {
...
type User_SecurityAdvisory_CvssSeverities struct {
	CvssV3 any
	CvssV4 any
}

type User_SecurityAdvisory_Cwes struct {
	CweId any
	Name  any
}

type User_SecurityAdvisory_Epss struct {
	Percentage any
	Percentile any
}

type User_SecurityAdvisory_Identifiers struct {
	Type  any
	Value any
}

type User_SecurityAdvisory_References struct {
	Url any
}

type User_SecurityAdvisory_Vulnerabilities_FirstPatchedVersion struct {
	Identifier any
}

type User_SecurityAdvisory_Vulnerabilities struct {
...
type User_SecurityAdvisory struct {
