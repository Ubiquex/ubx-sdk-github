...
type ScanningBypassRequest_Data struct {
	Branch any
	BypassReason any
	Path any
	SecretType any
...
type ScanningBypassRequest_Organization struct {
...
type ScanningBypassRequest_Repository struct {
...
type ScanningBypassRequest_Requester struct {
...
type ScanningBypassRequest_Responses struct {
	CreatedAt any
	Id any
	Reviewer any
	Status any
...
type ScanningBypassRequestConfig struct {
	BypassRequestNumber any
	Owner any
	Repo any
}

type ScanningBypassRequestAttrs struct {
	BypassRequestNumber any
...
var ScanningBypassRequest = ubx.DataSourceBinding{
