...
class SearchResultItemList_Items_Assignee:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_IssueDependenciesSummary:
    blocked_by: Any = None
    blocking: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_IssueFieldValues_MultiSelectOptions:
    color: Any = None
    id: Any = None
    name: Any = None

@dataclasses.dataclass
class SearchResultItemList_Items_IssueFieldValues:
    data_type: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_Labels:
    color: Any = None
    default: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_Milestone:
    closed_at: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_PerformedViaGithubApp_Owner:
    avatar_url: Any = None
    created_at: Any = None
    description: Any = None
    email: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_PerformedViaGithubApp_Permissions:
    checks: Any = None
    contents: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_PerformedViaGithubApp:
    client_id: Any = None
    created_at: Any = None
    description: Any = None
    events: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_PinnedComment_Minimized:
    reason: Any = None

@dataclasses.dataclass
class SearchResultItemList_Items_PinnedComment_Pin:
    pinned_at: Any = None
    pinned_by: Any = None

@dataclasses.dataclass
class SearchResultItemList_Items_PinnedComment_Reactions:
    confused: Any = None
    eyes: Any = None
    heart: Any = None
    hooray: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_PinnedComment:
...
@dataclasses.dataclass
class SearchResultItemList_Items_PullRequest:
    diff_url: Any = None
    html_url: Any = None
    merged_at: Any = None
    patch_url: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_Repository_CodeSearchIndexStatus:
    lexical_commit_sha: Any = None
    lexical_search_ok: Any = None

@dataclasses.dataclass
class SearchResultItemList_Items_Repository_License:
    html_url: Any = None
    key: Any = None
    name: Any = None
    node_id: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_Repository_Permissions:
    admin: Any = None
    maintain: Any = None
    pull: Any = None
    push: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_Repository:
...
@dataclasses.dataclass
class SearchResultItemList_Items_SubIssuesSummary:
    completed: Any = None
...
@dataclasses.dataclass
class SearchResultItemList_Items_Type:
    color: Any = None
    created_at: Any = None
    description: Any = None
    id: Any = None
...
SearchResultItemList = ubx.DataSourceBinding(
    wire_type="github_issue_search_result_item_list",
    fields={
