...
class List_Environments_DeploymentBranchPolicy:
    custom_branch_policies: Any = None
    protected_branches: Any = None

@dataclasses.dataclass
class List_Environments_ProtectionRules_Reviewers_Reviewer_Parent:
...
@dataclasses.dataclass
class List_Environments_ProtectionRules_Reviewers_Reviewer_Permissions:
    admin: Any = None
    maintain: Any = None
    pull: Any = None
    push: Any = None
...
@dataclasses.dataclass
class List_Environments_ProtectionRules_Reviewers_Reviewer:
...
@dataclasses.dataclass
class List_Environments_ProtectionRules_Reviewers:
    reviewer: Any = None
    type: Any = None

@dataclasses.dataclass
class List_Environments_ProtectionRules:
    id: Any = None
    node_id: Any = None
...
List = ubx.DataSourceBinding(
    wire_type="github_environment_list",
    fields={
