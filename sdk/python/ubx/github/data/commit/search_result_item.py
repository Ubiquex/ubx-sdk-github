...
class SearchResultItem_Items_Author:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class SearchResultItem_Items_Commit_Author:
    date: Any = None
    email: Any = None
    name: Any = None

@dataclasses.dataclass
class SearchResultItem_Items_Commit_Tree:
    sha: Any = None
    url: Any = None

@dataclasses.dataclass
class SearchResultItem_Items_Commit_Verification:
    payload: Any = None
    reason: Any = None
    signature: Any = None
    verified: Any = None
...
@dataclasses.dataclass
class SearchResultItem_Items_Commit:
    author: Any = None
...
@dataclasses.dataclass
class SearchResultItem_Items_Parents:
    html_url: Any = None
    sha: Any = None
    url: Any = None

@dataclasses.dataclass
class SearchResultItem_Items_Repository_CodeOfConduct:
    body: Any = None
    html_url: Any = None
    key: Any = None
    name: Any = None
...
@dataclasses.dataclass
class SearchResultItem_Items_Repository_SecurityAndAnalysis_AdvancedSecurity:
    status: Any = None

@dataclasses.dataclass
class SearchResultItem_Items_Repository_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions_Reviewers:
    mode: Any = None
    reviewer_id: Any = None
    reviewer_type: Any = None

@dataclasses.dataclass
class SearchResultItem_Items_Repository_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions:
    reviewers: Any = None

@dataclasses.dataclass
class SearchResultItem_Items_Repository_SecurityAndAnalysis:
...
SearchResultItem = ubx.DataSourceBinding(
    wire_type="github_commit_search_result_item",
    fields={
