...
class SimpleRepositoryList_AccessibleRepositories_Owner:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class SimpleRepositoryList_AccessibleRepositories:
...
@dataclasses.dataclass
class SimpleRepositoryListConfig:
    enterprise: Any = None
    page: Any = None
    per_page: Any = None

@dataclasses.dataclass
class SimpleRepositoryListAttrs:
...
SimpleRepositoryList = ubx.DataSourceBinding(
    wire_type="github_nullable_simple_repository_list",
    fields={
