...
class SearchResultItem_Items_License:
    html_url: Any = None
    key: Any = None
    name: Any = None
    node_id: Any = None
...
@dataclasses.dataclass
class SearchResultItem_Items_Owner:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class SearchResultItem_Items_Permissions:
    admin: Any = None
    maintain: Any = None
    pull: Any = None
    push: Any = None
...
SearchResultItem = ubx.DataSourceBinding(
    wire_type="github_repo_search_result_item",
    fields={
