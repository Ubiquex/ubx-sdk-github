...
class Search_Items_Repository_CodeOfConduct:
    body: Any = None
    html_url: Any = None
    key: Any = None
    name: Any = None
...
@dataclasses.dataclass
class Search_Items_Repository_License:
    key: Any = None
    name: Any = None
    node_id: Any = None
    spdx_id: Any = None
...
@dataclasses.dataclass
class Search_Items_Repository_Owner:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class Search_Items_Repository_Permissions:
    admin: Any = None
    maintain: Any = None
    pull: Any = None
    push: Any = None
...
@dataclasses.dataclass
class Search_Items_Repository_SecurityAndAnalysis_AdvancedSecurity:
    status: Any = None

@dataclasses.dataclass
class Search_Items_Repository_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions_Reviewers:
    mode: Any = None
    reviewer_id: Any = None
    reviewer_type: Any = None

@dataclasses.dataclass
class Search_Items_Repository_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions:
    reviewers: Any = None

@dataclasses.dataclass
class Search_Items_Repository_SecurityAndAnalysis:
...
@dataclasses.dataclass
class Search_Items_TextMatches_Matches:
    indices: Any = None
    text: Any = None

@dataclasses.dataclass
class Search_Items_TextMatches:
    fragment: Any = None
    matches: Any = None
