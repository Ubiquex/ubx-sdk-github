...
@dataclasses.dataclass
class ResponseList_Organization:
...
ResponseList = ubx.DataSourceBinding(
    wire_type="github_bypass_response_list",
    fields={
