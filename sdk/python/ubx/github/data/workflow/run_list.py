...
class RunList_WorkflowRuns_Actor:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class RunList_WorkflowRuns_HeadCommit_Author:
    email: Any = None
    name: Any = None

@dataclasses.dataclass
class RunList_WorkflowRuns_HeadCommit:
    author: Any = None
    committer: Any = None
    id: Any = None
    message: Any = None
...
@dataclasses.dataclass
class RunList_WorkflowRuns_HeadRepository_CodeOfConduct:
    body: Any = None
    html_url: Any = None
    key: Any = None
    name: Any = None
...
@dataclasses.dataclass
class RunList_WorkflowRuns_HeadRepository_License:
    key: Any = None
    name: Any = None
    node_id: Any = None
    spdx_id: Any = None
...
@dataclasses.dataclass
class RunList_WorkflowRuns_HeadRepository_Permissions:
    admin: Any = None
    maintain: Any = None
    pull: Any = None
    push: Any = None
...
@dataclasses.dataclass
class RunList_WorkflowRuns_HeadRepository_SecurityAndAnalysis_AdvancedSecurity:
    status: Any = None

@dataclasses.dataclass
class RunList_WorkflowRuns_HeadRepository_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions_Reviewers:
    mode: Any = None
    reviewer_id: Any = None
    reviewer_type: Any = None

@dataclasses.dataclass
class RunList_WorkflowRuns_HeadRepository_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions:
    reviewers: Any = None

@dataclasses.dataclass
class RunList_WorkflowRuns_HeadRepository_SecurityAndAnalysis:
...
@dataclasses.dataclass
class RunList_WorkflowRuns_HeadRepository:
...
@dataclasses.dataclass
class RunList_WorkflowRuns_PullRequests_Base_Repo:
    id: Any = None
    name: Any = None
    url: Any = None

@dataclasses.dataclass
class RunList_WorkflowRuns_PullRequests_Base:
    ref: Any = None
    repo: Any = None
    sha: Any = None

@dataclasses.dataclass
class RunList_WorkflowRuns_PullRequests:
    base: Any = None
    head: Any = None
    id: Any = None
    number: Any = None
...
@dataclasses.dataclass
class RunList_WorkflowRuns_ReferencedWorkflows:
    path: Any = None
    ref: Any = None
    sha: Any = None

@dataclasses.dataclass
class RunList_WorkflowRuns:
    actor: Any = None
...
RunList = ubx.DataSourceBinding(
    wire_type="github_workflow_run_list",
    fields={
