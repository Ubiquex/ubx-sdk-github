...
class SuiteList_CheckSuites_App_Owner:
    avatar_url: Any = None
    created_at: Any = None
...
@dataclasses.dataclass
class SuiteList_CheckSuites_App_Permissions:
    checks: Any = None
    contents: Any = None
...
@dataclasses.dataclass
class SuiteList_CheckSuites_App:
    client_id: Any = None
    created_at: Any = None
    description: Any = None
    events: Any = None
...
@dataclasses.dataclass
class SuiteList_CheckSuites_HeadCommit_Author:
    email: Any = None
    name: Any = None

@dataclasses.dataclass
class SuiteList_CheckSuites_HeadCommit:
    author: Any = None
    committer: Any = None
    id: Any = None
    message: Any = None
...
@dataclasses.dataclass
class SuiteList_CheckSuites_PullRequests_Base_Repo:
    id: Any = None
    name: Any = None
    url: Any = None

@dataclasses.dataclass
class SuiteList_CheckSuites_PullRequests_Base:
    ref: Any = None
    repo: Any = None
    sha: Any = None

@dataclasses.dataclass
class SuiteList_CheckSuites_PullRequests:
    base: Any = None
    head: Any = None
    id: Any = None
    number: Any = None
...
@dataclasses.dataclass
class SuiteList_CheckSuites_Repository_CodeOfConduct:
    body: Any = None
    html_url: Any = None
    key: Any = None
    name: Any = None
...
@dataclasses.dataclass
class SuiteList_CheckSuites_Repository_License:
    key: Any = None
    name: Any = None
    node_id: Any = None
    spdx_id: Any = None
...
@dataclasses.dataclass
class SuiteList_CheckSuites_Repository_Owner:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
    followers_url: Any = None
...
@dataclasses.dataclass
class SuiteList_CheckSuites_Repository_Permissions:
    admin: Any = None
    maintain: Any = None
    pull: Any = None
    push: Any = None
...
@dataclasses.dataclass
class SuiteList_CheckSuites_Repository_SecurityAndAnalysis_AdvancedSecurity:
    status: Any = None

@dataclasses.dataclass
class SuiteList_CheckSuites_Repository_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions_Reviewers:
    mode: Any = None
    reviewer_id: Any = None
    reviewer_type: Any = None

@dataclasses.dataclass
class SuiteList_CheckSuites_Repository_SecurityAndAnalysis_SecretScanningDelegatedBypassOptions:
    reviewers: Any = None

@dataclasses.dataclass
class SuiteList_CheckSuites_Repository_SecurityAndAnalysis:
...
@dataclasses.dataclass
class SuiteList_CheckSuites_Repository:
...
@dataclasses.dataclass
class SuiteListAttrs:
    app_id: Any = None
    check_name: Any = None
    check_suites: Any = None
    owner: Any = None
    page: Any = None
    per_page: Any = None
    ref: Any = None
...
SuiteList = ubx.DataSourceBinding(
    wire_type="github_check_suite_list",
    fields={
