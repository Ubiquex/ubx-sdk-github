...
class RunList_CheckRuns_App_Owner:
    avatar_url: Any = None
    created_at: Any = None
...
@dataclasses.dataclass
class RunList_CheckRuns_App_Permissions:
    checks: Any = None
    contents: Any = None
...
@dataclasses.dataclass
class RunList_CheckRuns_CheckSuite:
    id: Any = None

@dataclasses.dataclass
class RunList_CheckRuns_Deployment:
    created_at: Any = None
    description: Any = None
...
@dataclasses.dataclass
class RunList_CheckRuns_Output:
...
@dataclasses.dataclass
class RunList_CheckRuns_PullRequests_Base_Repo:
    id: Any = None
    name: Any = None
    url: Any = None

@dataclasses.dataclass
class RunList_CheckRuns_PullRequests_Base:
    ref: Any = None
    repo: Any = None
    sha: Any = None

@dataclasses.dataclass
class RunList_CheckRuns_PullRequests:
    base: Any = None
    head: Any = None
    id: Any = None
    number: Any = None
...
RunList = ubx.DataSourceBinding(
    wire_type="github_check_run_list",
    fields={
