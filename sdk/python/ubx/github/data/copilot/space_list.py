...
class SpaceList_Spaces_Creator:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class SpaceList_Spaces_ResourcesAttributes_Metadata:
...
@dataclasses.dataclass
class SpaceList_Spaces_ResourcesAttributes:
    copilot_chat_attachment_id: Any = None
    created_at: Any = None
    id: Any = None
    metadata: Any = None
...
SpaceList = ubx.DataSourceBinding(
    wire_type="github_copilot_space_list",
    fields={
