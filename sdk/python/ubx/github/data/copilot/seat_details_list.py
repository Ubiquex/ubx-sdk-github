...
class SeatDetailsList_Seats_Assignee:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class SeatDetailsList_Seats_AssigningTeam_Parent:
...
@dataclasses.dataclass
class SeatDetailsList_Seats_AssigningTeam_Permissions:
    admin: Any = None
    maintain: Any = None
    pull: Any = None
    push: Any = None
...
@dataclasses.dataclass
class SeatDetailsList_Seats_AssigningTeam:
...
@dataclasses.dataclass
class SeatDetailsList_Seats_Organization:
    avatar_url: Any = None
    description: Any = None
    events_url: Any = None
    hooks_url: Any = None
...
@dataclasses.dataclass
class SeatDetailsListConfig:
    enterprise: Any = None
    page: Any = None
    per_page: Any = None

@dataclasses.dataclass
class SeatDetailsListAttrs:
    enterprise: Any = None
    page: Any = None
    per_page: Any = None
    seats: Any = None
...
SeatDetailsList = ubx.DataSourceBinding(
    wire_type="github_copilot_seat_details_list",
    fields={
