...
@dataclasses.dataclass
class RequestResponse_Organization:
...
@dataclasses.dataclass
class RequestResponse_Repository:
...
@dataclasses.dataclass
class RequestResponse_Requester:
...
@dataclasses.dataclass
class RequestResponse_Responses:
    created_at: Any = None
    id: Any = None
    message: Any = None
    reviewer: Any = None
...
RequestResponse = ubx.DataSourceBinding(
    wire_type="github_dismissal_request_response",
    fields={
