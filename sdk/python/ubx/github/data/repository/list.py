...
class List_Repositories_CodeSearchIndexStatus:
    lexical_commit_sha: Any = None
    lexical_search_ok: Any = None

@dataclasses.dataclass
class List_Repositories_License:
    html_url: Any = None
    key: Any = None
    name: Any = None
    node_id: Any = None
...
@dataclasses.dataclass
class List_Repositories_Permissions:
    admin: Any = None
    maintain: Any = None
    pull: Any = None
    push: Any = None
...
List = ubx.DataSourceBinding(
    wire_type="github_repository_list",
    fields={
