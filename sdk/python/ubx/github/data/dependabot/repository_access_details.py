...
class RepositoryAccessDetails_AccessibleRepositories_Owner:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class RepositoryAccessDetails_AccessibleRepositories:
...
@dataclasses.dataclass
class RepositoryAccessDetailsConfig:
    enterprise: Any = None
    page: Any = None
    per_page: Any = None

@dataclasses.dataclass
class RepositoryAccessDetailsAttrs:
...
RepositoryAccessDetails = ubx.DataSourceBinding(
    wire_type="github_dependabot_repository_access_details",
    fields={
