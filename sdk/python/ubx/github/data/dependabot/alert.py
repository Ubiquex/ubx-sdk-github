...
@dataclasses.dataclass
class Alert_Dependency_Package:
...
@dataclasses.dataclass
class Alert_DismissalRequest_Requester:
...
@dataclasses.dataclass
class Alert_SecurityAdvisory_Cvss:
...
@dataclasses.dataclass
class Alert_SecurityAdvisory_CvssSeverities:
    cvss_v3: Any = None
    cvss_v4: Any = None

@dataclasses.dataclass
class Alert_SecurityAdvisory_Cwes:
    cwe_id: Any = None
    name: Any = None

@dataclasses.dataclass
class Alert_SecurityAdvisory_Epss:
    percentage: Any = None
    percentile: Any = None

@dataclasses.dataclass
class Alert_SecurityAdvisory_Identifiers:
    type: Any = None
    value: Any = None

@dataclasses.dataclass
class Alert_SecurityAdvisory_References:
    url: Any = None

@dataclasses.dataclass
class Alert_SecurityAdvisory_Vulnerabilities_FirstPatchedVersion:
    identifier: Any = None

@dataclasses.dataclass
class Alert_SecurityAdvisory_Vulnerabilities:
...
Alert = ubx.DataSourceBinding(
    wire_type="github_dependabot_alert",
    fields={
