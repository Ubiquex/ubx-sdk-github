...
@dataclasses.dataclass
class UserList_Dependency_Package:
...
@dataclasses.dataclass
class UserList_DismissalRequest_Requester:
...
@dataclasses.dataclass
class UserList_DismissalRequest:
...
@dataclasses.dataclass
class UserList_SecurityAdvisory_Cvss:
...
@dataclasses.dataclass
class UserList_SecurityAdvisory_CvssSeverities:
    cvss_v3: Any = None
    cvss_v4: Any = None

@dataclasses.dataclass
class UserList_SecurityAdvisory_Cwes:
    cwe_id: Any = None
    name: Any = None

@dataclasses.dataclass
class UserList_SecurityAdvisory_Epss:
    percentage: Any = None
    percentile: Any = None

@dataclasses.dataclass
class UserList_SecurityAdvisory_Identifiers:
    type: Any = None
    value: Any = None

@dataclasses.dataclass
class UserList_SecurityAdvisory_References:
    url: Any = None

@dataclasses.dataclass
class UserList_SecurityAdvisory_Vulnerabilities_FirstPatchedVersion:
    identifier: Any = None

@dataclasses.dataclass
class UserList_SecurityAdvisory_Vulnerabilities:
...
@dataclasses.dataclass
class UserList_SecurityAdvisory:
...
UserList = ubx.DataSourceBinding(
    wire_type="github_simple_user_list",
    fields={
