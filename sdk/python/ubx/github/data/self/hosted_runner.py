...
class HostedRunner_Repositories_CodeSearchIndexStatus:
    lexical_commit_sha: Any = None
    lexical_search_ok: Any = None

@dataclasses.dataclass
class HostedRunner_Repositories_License:
    html_url: Any = None
    key: Any = None
    name: Any = None
    node_id: Any = None
...
@dataclasses.dataclass
class HostedRunner_Repositories_Owner:
    avatar_url: Any = None
    email: Any = None
    events_url: Any = None
...
@dataclasses.dataclass
class HostedRunner_Repositories_Permissions:
    admin: Any = None
    maintain: Any = None
    pull: Any = None
    push: Any = None
...
@dataclasses.dataclass
class HostedRunner_Repositories:
