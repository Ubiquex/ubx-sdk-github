...
class RuleBypassRequest_Data:
    rule_type: Any = None
    ruleset_id: Any = None
    ruleset_name: Any = None
    total_violations: Any = None

@dataclasses.dataclass
class RuleBypassRequest_Organization:
...
@dataclasses.dataclass
class RuleBypassRequest_Repository:
...
@dataclasses.dataclass
class RuleBypassRequest_Requester:
...
@dataclasses.dataclass
class RuleBypassRequest_Responses:
    created_at: Any = None
    id: Any = None
    reviewer: Any = None
    status: Any = None
...
@dataclasses.dataclass
class RuleBypassRequestConfig:
    bypass_request_number: Any = None
    owner: Any = None
    repo: Any = None

@dataclasses.dataclass
class RuleBypassRequestAttrs:
    bypass_request_number: Any = None
...
RuleBypassRequest = ubx.DataSourceBinding(
    wire_type="github_push_rule_bypass_request",
    fields={
